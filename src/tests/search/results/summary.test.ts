...
export function runSummaryTests(context: ITestContext) {
    ...
    it("Should return only text, id, meta, and top-level mandatory elements when _summary=text", async () => {
        ...
        assertExists(returnedPatient.meta, "Text summary should include meta");
        assertExists(returnedPatient.text, "Text summary should include text");
        assertEquals(
    ...
    it("Should remove the text element when _summary=data", async () => {
        ...
        assertExists(returnedPatient.meta, "Data summary should include meta");
        assertEquals(
            returnedPatient.text,
            undefined,
            "Data summary should not include text",
        );
        assertExists(returnedPatient.name, "Data summary should include name");
        assertExists(
            returnedPatient.gender,
    ...
    it("Should return all parts of the resource when _summary=false", async () => {
        ...
        assertExists(returnedPatient.meta, "Full resource should include meta");
        assertExists(returnedPatient.text, "Full resource should include text");
        assertExists(returnedPatient.name, "Full resource should include name");
        assertExists(
            returnedPatient.gender,
